...
import { WordpressLogoModel } from "./wordpress-logo-model";
...
export function WordpressLogoScene() {
  return (
    <CanvasErrorBoundary
      fallback={
        <div className="flex h-full w-full items-center justify-center bg-neutral-900 text-white">
          <p className="text-sm text-neutral-400">WordPress 3D Model Preview</p>
        </div>
      }
    >
      <Canvas
      ...
      >
        ...
        {/* WordPress Blue Accent Point Light */}
        <pointLight
          position={[-4, -2, 4]}
          intensity={1.8}
          color="#21759b"
