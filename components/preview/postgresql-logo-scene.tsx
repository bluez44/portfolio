...
import { PostgresqlLogoModel } from "./postgresql-logo-model";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* PostgreSQL Blue Front Accent Point Light */}
        <pointLight
          position={[2, 2, 5]}
          intensity={1.5}
          color="#336791"
