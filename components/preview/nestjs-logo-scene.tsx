...
import { NestJSLogoModel } from "./nestjs-logo-model";
...
export function NestJSLogoScene() {
  return (
    <CanvasErrorBoundary
      fallback={
        <div className="flex h-full w-full items-center justify-center bg-neutral-900 text-white">
          <p className="text-sm text-neutral-400">NestJS 3D Model Preview</p>
        </div>
      }
    >
      <Canvas
