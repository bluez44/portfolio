...
import { NodeJSLogoModel } from "./nodejs-logo-model";
...
export function NodeJSLogoScene() {
  return (
    <CanvasErrorBoundary
      fallback={
        <div className="flex h-full w-full items-center justify-center bg-neutral-900 text-white">
          <p className="text-sm text-neutral-400">Node.js 3D Model Preview</p>
        </div>
      }
    >
      <Canvas
      ...
      >
        ...
        {/* Node.js Green Accent Point Light */}
        <pointLight
          position={[-4, -2, 4]}
          intensity={1.8}
          color="#339933"
