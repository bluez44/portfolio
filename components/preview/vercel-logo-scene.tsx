...
import { VercelLogoModel } from "./vercel-logo-model";
...
export function VercelLogoScene() {
  return (
    <CanvasErrorBoundary
      fallback={
        <div className="flex h-full w-full items-center justify-center bg-neutral-900 text-white">
          <p className="text-sm text-neutral-400">Vercel 3D Model Preview</p>
        </div>
      }
    >
      <Canvas
      ...
      >
        ...
        {/* Cool Fill — the mark is achromatic, so the accent stays neutral */}
        <pointLight
          position={[-4, -2, 4]}
          intensity={1.6}
          color="#8fa3bd"
