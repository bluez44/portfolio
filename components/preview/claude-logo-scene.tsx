...
import { ClaudeLogoModel } from "./claude-logo-model";
...
export function ClaudeLogoScene() {
  return (
    <CanvasErrorBoundary
      fallback={
        <div className="flex h-full w-full items-center justify-center bg-neutral-900 text-white">
          <p className="text-sm text-neutral-400">Claude 3D Model Preview</p>
        </div>
      }
    >
      <Canvas
      ...
      >
        ...
        {/* Claude Coral Accent Point Light */}
        <pointLight
          position={[-4, -2, 4]}
          intensity={1.8}
          color="#d97757"
