...
import { SocketIOLogoModel } from "./socketdotio-logo-model";
...
export function SocketIOLogoScene() {
  return (
    <CanvasErrorBoundary
      fallback={
        <div className="flex h-full w-full items-center justify-center bg-[#f0f0f0] text-[#121212]">
          <p className="text-sm font-medium">Socket.IO 3D Model Preview</p>
        </div>
      }
    >
      <Canvas
