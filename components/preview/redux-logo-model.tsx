 ...
 * 1. Uses client-side SVGLoader to extrude Redux's iconic Ouroboros (cyclic arrow)
 *    mark from the official Simple Icons SVG.
 * 2. Redux signature purple (#764abc) MeshPhysicalMaterial with deep violet emissive
 *    and premium clearcoat metallic finish.
 * 3. Smooth floating animation with gentle Y-axis oscillation.
 */

const REDUX_PURPLE = "#764abc";
const REDUX_EMISSIVE = "#2d1a4a";
