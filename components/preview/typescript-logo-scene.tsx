...
import { TypeScriptLogoModel } from "./typescript-logo-model";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Pure White Front Accent Light to make white TS text pop brilliantly */}
        <pointLight
          position={[2, 2, 5]}
          intensity={1.5}
          color="#ffffff"
