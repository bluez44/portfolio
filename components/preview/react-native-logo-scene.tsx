...
import { ReactNativeLogoModel } from "./react-native-logo-model";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Signature React Cyan Accent Point Light */}
        <pointLight
          position={[-4, -2, 4]}
          intensity={1.8}
          color="#61dafb"
        ...
        <TurntableGroup>
          <ReactNativeLogoModel scale={1.2} />
        </TurntableGroup>
      </Canvas>
    </CanvasErrorBoundary>
  );
