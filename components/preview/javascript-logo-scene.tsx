...
import { JavascriptLogoModel } from "./javascript-logo-model";
...
export function JavascriptLogoScene() {
  return (
    <CanvasErrorBoundary
      fallback={
        <div className="flex h-full w-full items-center justify-center bg-neutral-900 text-white">
          <p className="text-sm text-neutral-400">JavaScript 3D Model Preview</p>
        </div>
      }
    >
      <Canvas
        ...
        dpr={[1, 2]}
        // shadows
        camera={{ fov: 32, near: 0.1, far: 100, position: [0, 0, 16] }}
      >
        ...
        {/* JavaScript Yellow Accent Point Light */}
        <pointLight
          position={[-4, -2, 4]}
          intensity={1.5}
          color="#f7df1e"
